package org.albaspazio.psysuite.tests.mmd
 ...
 *                   Defaults to a list containing only "org.albaspazio.psysuite.tests.mmd.TestMMD".
...
class SubjectMMDParcel(
    ...
    override var classes: List<String> = listOf("org.albaspazio.psysuite.tests.mmd.TestMMD"),
